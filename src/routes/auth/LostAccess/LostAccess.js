...
function PhoneCheck({nextStep, lostAccess}) {
  ...
  return (
    <div className={styles.centering} >
        ...
        <p>
          <span className={styles.purpleText}>Enter your email address</span> associated with your account
        </p>
        
        <input placeholder='johndoe@example.com' className={styles.inputPhone} type='text' maxLength='10'></input>
