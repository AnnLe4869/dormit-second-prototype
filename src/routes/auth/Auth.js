...
export default function Auth() {
  ...
  if (step === 1) {
    showStep = <PhoneCheck nextStep={nextStep} lostAccess={lostAccess} />;
  }
  if (step === 2) {
    showStep = <PhoneAuth nextStep={nextStep} />;
  }
  if (step === 3) {
    showStep = <Register nextStep={nextStep} />;
  }
  ...
  if (lostAccessStep === 1) {
    lostAccessSteps = <LostAccess nextStep={nextAccessStep} />;
  }
  if (lostAccessStep === 2) {
    lostAccessSteps = <PhoneAuth nextStep={nextAccessStep} />;
  }
  if (lostAccessStep === 3) {
    lostAccessSteps = <Register nextStep={nextAccessStep} />;
  }
