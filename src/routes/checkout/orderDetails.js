        ...
        <Form>
            <div className={styles.addressForm}>
                ...
                <div className={styles.inputs}>
                    <FormGroup style={{"margin-right":"50px"}} className={styles.inputDiv}>
                        <Form.Label bsPrefix={styles.inputTitle}>UCSD Building</Form.Label>
                        <Form.Control type="input" placeholder="Building Name" required/>
                    </FormGroup>
                    <FormGroup className={styles.inputDiv}>
                        <Form.Label bsPrefix={styles.inputTitle}>Floor / Apt #</Form.Label>
                ...
                <div className={styles.wh}>
                    <Stack>
                        ...
                        <ButtonGroup bsPrefix={styles.replacement} required>
                            <Button className={styles.replacementButton} type="button"><div className={styles.tip}>Pick for me</div></Button>
                            <Button className={styles.replacementButton} type="button"><div className={styles.tip}>Call me</div></Button>
                            <Button className={styles.replacementButton} type="button"><div className={styles.tip}>Refund me</div></Button>
                        </ButtonGroup>
                    </Stack>
                </div>
                <div className={styles.wh}>
