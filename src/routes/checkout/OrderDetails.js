...
const OrderDetails = () => {
  ...
  return (
    <>
    <header>
        <button className={styles.back}><ArrowBackIosIcon fontSize='large'/></button>
        <p> Order Details </p>
    </header>
    ...
    <div className={styles.body}>
        ...
        <div className={styles.addressBox}>
            ...
            <div className={styles.input}>
                ...
                <TextField id="outlined-basic" label="UCSD Building" variant="outlined" required sx={{"height":"inherit", "width":"343px"}}/>
            </div>
            <div className={styles.input}>
                <div>Floor / Apartment #</div>
                <TextField id="outlined-basic" label="1/12" required variant="outlined" sx={{"height":"inherit", "width":"343px"}}/>
            </div>
            <div className={styles.input}>
                <div>Notes for Rusher</div>
                <TextField id="outlined-basic" label="Notes" variant="outlined" sx={{"height":"inherit", "width":"343px"}}/>
            </div>
        </div>
        ...
        <div className={styles.paymentBox}>
            ...
            <div className={styles.input}>
                ...
                <button style={{"border" : "0", "background" : "none", "cursor":"pointer"}}><NavigateNextIcon /></button>
            </div>
        </div>
        ...
        <button className={styles.placeOrder} style={{"background" : "#008CFF", "column-gap":"10px"}}>
