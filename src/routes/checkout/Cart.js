        ...
        <Modal.Footer style={{'white-space' : 'normal'}}>
          ...
          <Container style = {{'max-width':'384px'}}>
            <Row style = {{'margin-bottom':'13px'}}>
              <Col><div className={styles.footerSubs}>Subtotal</div></Col>
              <Col style={{'text-align': 'right'}}><div className={styles.footerSubs}>$X.XX</div></Col>
            </Row>
            <Row style = {{'margin-bottom':'13px'}}>
              <Col><div className={styles.footerSubs}>Tax</div></Col>
              <Col style={{'text-align': 'right'}}><div className={styles.footerSubs}>$X.XX</div></Col>
            </Row>
            <Row style = {{'margin-bottom':'13px'}}>
              <Col><div className={styles.footerSubs}>Delivery</div></Col>
              <Col style={{'text-align': 'right'}}><div className={styles.footerSubs}>$X.XX</div></Col>
            </Row>
            <Row style = {{'margin-bottom':'13px'}}>
              <Col><div className={styles.footerTotal}>Total</div></Col>
              <Col style={{'text-align': 'right'}}><div className={styles.footerTotal}>$X.XX</div></Col>
            </Row>
          </Container>

          <button className={styles.footerButton} onClick={() => {navigate("/order/details")}}>
