      ...
      <div className={HomeCSS.homeContainer}>
        <div className={HomeCSS.homeContent}>
          ...
          <section className={HomeCSS.homeCategoryNav}>
            <Button
              variant="outlined"
              sx={homepageStyles.categoryButton}
              onClick={(e) => scrollToCategory(0)}
            >
