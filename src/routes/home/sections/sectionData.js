...
const mockForYouItems = [
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={2} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={0} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={1} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={5} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={2} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={0} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={1} />,
    <ProductListing id="apple" name="Apple" image={apple} price="Price" stock={5} />,
