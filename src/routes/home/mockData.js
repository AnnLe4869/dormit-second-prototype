...
const candy = [
    <ItemEntry id="apple" name="Skittles" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Recess" image={apple} price="Price" stock={1} />,
    <ItemEntry id="apple" name="Snickers" image={apple} price="Price" stock={5} />,
    ...
    <ItemEntry id="apple" name="Milky Way" image={apple} price="Price" stock={5} />,
    <ItemEntry id="apple" name="Hersheys" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Milk Duds" image={apple} price="Price" stock={1} />,
...
const chips = [
    ...
    <ItemEntry id="apple" name="Pirate's Booty" image={apple} price="Price" stock={1} />,
    <ItemEntry id="apple" name="Cape Cod" image={apple} price="Price" stock={5} />,
    <ItemEntry id="apple" name="Mr. Potato" image={apple} price="Price" stock={0} />,
...
const drinks = [
    <ItemEntry id="apple" name="Mountain Dew" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Coke" image={apple} price="Price" stock={1} />,
    <ItemEntry id="apple" name="Milk" image={apple} price="Price" stock={5} />,
    <ItemEntry id="apple" name="Orange Juice" image={apple} price="Price" stock={0} />,
...
const iceCream = [
    <ItemEntry id="apple" name="Ben and Jerrys" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="McFlurry" image={apple} price="Price" stock={1} />,
    <ItemEntry id="apple" name="ice cream3" image={apple} price="Price" stock={5} />,
    <ItemEntry id="apple" name="ice cream4" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Twix" image={apple} price="Price" stock={1} />,
    <ItemEntry id="apple" name="Milky Way" image={apple} price="Price" stock={5} />,
    <ItemEntry id="apple" name="Hersheys" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Milk Duds" image={apple} price="Price" stock={1} />,
...
const readyToEat = [
    <ItemEntry id="apple" name="Spaghetti" image={apple} price="Price" stock={0} />,
    <ItemEntry id="apple" name="Breakfast Sandwich" image={apple} price="Price" stock={1} />,
